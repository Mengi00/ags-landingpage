...
export default function ModernHero() {
  ...
  return (
    <section id="hero" className="w-full bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] py-32 lg:py-40 relative overflow-hidden min-h-[85vh] flex items-center">
