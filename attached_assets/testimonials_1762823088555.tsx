...
export default function Testimonials() {
  const testimonials = [
    {
      company: "Collahuasi",
      text: "AGS nos permitió recuperar más de 2,500 millones en solo 6 meses",
      result: "+2.5B",
    },
    {
      company: "CCU",
      text: "Redujimos tiempos de tramitación en un 80% con WebSIL",
      result: "-80%",
    },
    {
      company: "Metro",
      text: "Sistema completamente transparent y confiable para nuestra gestión",
      result: "Eficiencia",
    },
  ]
